...
CREATE INDEX IF NOT EXISTS IDX_MAINT_LOG_ASSET 
    ON MAINTENANCE_LOG_DOCUMENTS(ASSET_ID);

CREATE INDEX IF NOT EXISTS IDX_MAINT_LOG_DATE 
    ON MAINTENANCE_LOG_DOCUMENTS(DOCUMENT_DATE);
...
CREATE INDEX IF NOT EXISTS IDX_MANUAL_MANUFACTURER 
    ON TECHNICAL_MANUALS(MANUFACTURER, MODEL);
...
CREATE INDEX IF NOT EXISTS IDX_CV_ASSET 
    ON CV_DETECTIONS(ASSET_ID);

CREATE INDEX IF NOT EXISTS IDX_CV_SEVERITY 
    ON CV_DETECTIONS(SEVERITY_LEVEL, REQUIRES_IMMEDIATE_ACTION);
