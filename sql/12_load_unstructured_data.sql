...
-- Grant permissions to Cortex Search services (for Intelligence Agent use)
...
GRANT USAGE ON CORTEX SEARCH SERVICE TECHNICAL_MANUAL_SEARCH TO ROLE GRID_ML_ENGINEER;
